...
export function SubscriptionGate({ children, feature = "this feature", showUpgradePrompt = true }: SubscriptionGateProps) {
  ...
  const { hasAccess, isLoading, isTrialActive, trialDaysRemaining, hasUsedTrial, startTrial, isStartingTrial, createCheckout, isCreatingCheckout } = useSubscription();
      ...
      <CardContent className="space-y-4">
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            {isCreatingCheckout ? t('common.loading') : t('subscription.subscribePro')}
          </Button>
        </div>
